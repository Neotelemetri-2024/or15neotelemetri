  ...
  return (
    <div className="bg-black relative min-h-screen flex items-center justify-center overflow-hidden px-4">
      ...
      <img
        ...
        style={{ top: "20px", right: "24px", height: "40px", zIndex: 20 }}
      />
      <div className="relative z-10 flex flex-col items-center gap-4 text-center">
        ...
        <p className="text-white/50 text-sm max-w-xs">
          Masa Open Recruitment UKM Neo Telemetri XV telah berakhir.
          <br />
          Terima kasih atas antusias kalian!
        </p>
        <Link
          to="/"
          className="mt-4 px-6 py-2.5 rounded-full text-sm font-semibold text-white transition-all"
          style={{
...
//         {/* LEFT */}
//         <div className="text-white space-y-3 text-center hidden lg:block">
