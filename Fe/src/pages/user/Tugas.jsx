            ...
            {assignments.length === 0 ? (
              ...
              <>
                ...
                >
                  ...
                  <span>
                    Tekan tombol{" "}
                    <strong className="text-white/80">Lihat</strong> pada
                    tugas untuk melihat deskripsi, file, dan tombol pengumpulan.
                  </span>
                </div>
                          ...
                          {tugas.fileUrl && (
                            <div>
                              ...
                              <div className="flex gap-2">
                                <button
                                  onClick={() => handlePreview(tugas.id)}
                                  disabled={!!loadingFile[tugas.id]}
                                  className="inline-flex items-center gap-2 px-4 py-2 rounded-full text-white text-xs font-semibold disabled:opacity-60"
                                  style={{
                                    background:
                                      "linear-gradient(135deg,#0077CC,#004499)",
                                  }}
                                >
                                  {loadingFile[tugas.id] === "preview" ? (
                                    "Membuka..."
                                  ) : (
                                    <>
                                ...
                                <button
                                  onClick={() => handleDownload(tugas.id)}
                                  disabled={!!loadingFile[tugas.id]}
                                  className="inline-flex items-center gap-2 px-4 py-2 rounded-full text-white text-xs font-semibold disabled:opacity-60"
                                  style={{
                                    background:
                          ...
                          {submitted && tugas.submissions[0]?.score != null && (
                            ...
                            >
                              ...
                              <span className="text-green-600 font-bold text-base">
                                {parseFloat(tugas.submissions[0].score).toFixed(
                                  1,
                                )}
                              </span>
                            </div>
                              ...
                              onClick={() =>
                                navigate("/pengumpulan", {
                                  state: {
                                    ...
                                    deadline: formatDeadline(tugas.dueAt),
                                    existingSubmission:
                                      tugas.submissions?.[0] || null,
                                    // submissions[0] harus include: id, fileUrl, textContent, score
                                  },
                                })
                              }
