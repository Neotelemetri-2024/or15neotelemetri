  ...
  return (
    <div>
      ...
      <div className="flex items-center rounded-lg overflow-hidden">
        ...
        {/* Chevron toggle — only show when there are children AND label is visible */}
  ...
  return (
    <div className="flex min-h-screen bg-[#1a0023] text-white overflow-hidden relative">
      ...
      <img
        src={circlePurple}
        alt=""
        className="absolute -top-20 left-1/3 w-[300px] pointer-events-none"
      />
      <img
        src={circlePurple}
        alt=""
