...
// Circuit line data - dense on left side, flowing right
const CIRCUIT_LINES = [
  // === LEFT CLUSTER - Dense vertical/horizontal mesh ===
  {
    x: 0,
    y: 150,
    segments: [
  ...
  return (
    <div className="bg-black relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <img
        ...
        style={{
          top: "50%",
          left: "10px", // lebih keluar dari layar
          transform: "translateY(-50%) scale(1.25)", // sedikit diperbesar
      ...
      {/* ── PURPLE ARC GLOWS (PNG) ───────────────── */}

      {/* Arc 1 — kanan atas: arc melengkung ke bawah */}
      <img
        src={purpleRing}
        alt=""
        className="absolute pointer-events-none select-none"
      ...
      {/* Arc 2 — bawah tengah: diputar 180° agar melengkung ke atas */}
      <img
        src={purpleRing}
        alt=""
        className="absolute pointer-events-none select-none"
      ...
      <div className="relative z-10 w-full max-w-6xl grid md:grid-cols-2 items-center gap-12 p-6">
        ...
        <div
          ...
          style={{
            WebkitMaskImage:
              "linear-gradient(to right, rgba(0,0,0,1) 50%, rgba(0,0,0,0.6) 70%, transparent 100%)",
            maskImage:
              "linear-gradient(to right, rgba(0,0,0,1) 50%, rgba(0,0,0,0.6) 70%, transparent 100%)",
          }}
        >
        ...
        <div className="flex justify-center">
          ...
          >
            <h2 className="text-3xl font-bold mb-8 tracking-wide">Daftar</h2>
