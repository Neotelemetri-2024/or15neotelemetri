...
export default function AddMateriAdmin() {
  ...
  const handleFile = (file) => { if (file) setForm((p) => ({ ...p, file })); };
  const handleDrop = (e) => {
    e.preventDefault();
    setDragging(false);
    ...
    <AdminLayout>
      <div className="min-h-screen flex flex-col gap-4 pt-10 md:pt-4">
        ...
        <div className="mt-6">
          ...
          >
            <p className="text-gray-800 font-bold text-sm">Add materi</p>
            ...
            <div className="flex flex-col gap-1">
              ...
              >
                ...
                {form.file ? (
                  <p className="text-gray-600 text-xs font-medium text-center px-4">
                    {form.file.name}
                  </p>
                ) : (
                  <>
                ...
                {/* TOMBOL IMPOR — inline di mobile, absolute di desktop */}
                <button
            ...
            <div className="flex justify-end">
              <button
                onClick={() => console.log("Kirim materi:", { division: activeDivision, ...form })}
