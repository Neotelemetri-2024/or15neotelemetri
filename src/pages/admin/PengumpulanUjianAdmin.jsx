              ...
              <table className="w-full text-sm min-w-[280px]">
                <thead>
                  <tr style={{ borderBottom: "1.5px solid rgba(0,0,0,0.07)" }}>
                    {columns.map((col) => (
                      <th key={col} className="text-left px-4 py-3 text-xs font-bold text-gray-700 whitespace-nowrap">
                        {col}
                      </th>
                    ))}
                  </tr>
                ...
                <tbody>
                  {filtered.map((row, i) => (
                    ...
                    >
                      ...
                      <td className="p-5 text-gray-600 text-xs">{row.hasil}</td>
                    </tr>
                  ))}

                  {filtered.length === 0 && (
                    <tr>
                      <td colSpan={2} className="text-center py-10 text-gray-400 text-sm">
